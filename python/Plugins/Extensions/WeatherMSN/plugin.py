...
#
		...
		self.sunrise['Sunrise'] = '%02d:%s%s' % (SRh, SRx, SRm)
		self.sunset['Sunset'] = '%02d:%s%s' % (SSh, SSx, SSm)
		self.sunculmination['Solstice'] = '%02d:%s%s' % (SCh, SCx, SCm)
		self.mercuryrise['Mercuryrise'] = '%02d:%s%s' % (P1Rh, P1Rx, P1Rm)
		self.mercuryset['Mercuryset'] = '%02d:%s%s' % (P1Sh, P1Sx, P1Sm)
		self.mercuryculmination['Mercuryculmination'] = '%02d:%s%s' % (P1Ch, P1Cx, P1Cm)
		self.mercuryazimuth['Mercuryazimuth'] = '%s %s' % (P1A, chr(176))
		self.venusrise['Venusrise'] = '%02d:%s%s' % (P2Rh, P2Rx, P2Rm)
		self.venusset['Venusset'] = '%02d:%s%s' % (P2Sh, P2Sx, P2Sm)
		self.venusculmination['Venusculmination'] = '%02d:%s%s' % (P2Ch, P2Cx, P2Cm)
		self.venusazimuth['Venusazimuth'] = '%s %s' % (P2A, chr(176))
		self.marsrise['Marsrise'] = '%02d:%s%s' % (P4Rh, P4Rx, P4Rm)
		self.marsset['Marsset'] = '%02d:%s%s' % (P4Sh, P4Sx, P4Sm)
		self.marsculmination['Marsculmination'] = '%02d:%s%s' % (P4Ch, P4Cx, P4Cm)
		self.marsazimuth['Marsazimuth'] = '%s %s' % (P4A, chr(176))
		self.jupiterrise['Jupiterrise'] = '%02d:%s%s' % (P5Rh, P5Rx, P5Rm)
		self.jupiterset['Jupiterset'] = '%02d:%s%s' % (P5Sh, P5Sx, P5Sm)
		self.jupiterculmination['Jupiterculmination'] = '%02d:%s%s' % (P5Ch, P5Cx, P5Cm)
		self.jupiterazimuth['Jupiterazimuth'] = '%s %s' % (P5A, chr(176))
		self.saturnrise['Saturnrise'] = '%02d:%s%s' % (P6Rh, P6Rx, P6Rm)
		self.saturnset['Saturnset'] = '%02d:%s%s' % (P6Sh, P6Sx, P6Sm)
		self.saturnculmination['Saturnculmination'] = '%02d:%s%s' % (P6Ch, P6Cx, P6Cm)
		self.saturnazimuth['Saturnazimuth'] = '%s %s' % (P6A, chr(176))
		self.uranusrise['Uranusrise'] = '%02d:%s%s' % (P7Rh, P7Rx, P7Rm)
		self.uranusset['Uranusset'] = '%02d:%s%s' % (P7Sh, P7Sx, P7Sm)
		self.uranusculmination['Uranusculmination'] = '%02d:%s%s' % (P7Ch, P7Cx, P7Cm)
		self.uranusazimuth['Uranusazimuth'] = '%s %s' % (P7A, chr(176))
		self.neptunerise['Neptunerise'] = '%02d:%s%s' % (P8Rh, P8Rx, P8Rm)
		self.neptuneset['Neptuneset'] = '%02d:%s%s' % (P8Sh, P8Sx, P8Sm)
		self.neptuneculmination['Neptuneculmination'] = '%02d:%s%s' % (P8Ch, P8Cx, P8Cm)
		...
		self.moonrise['Moonrise'] = '%02d:%s%s' % (MRh, MRx, MRm)
		self.moonset['Moonset'] = '%02d:%s%s' % (MSh, MSx, MSm)
		self.moonculmination['Moonculmination'] = '%02d:%s%s' % (MCh, MCx, MCm)
